...
def loadConfig(ConfigFile: str, databaseFileOverrider=None):
	...
	if databaseFileOverrider is None:
		globals()['databaseFile'] = config['database_filename']
	else:
		globals()['databaseFile'] = databaseFileOverrider
		globals()['config']['database_filename'] = databaseFileOverrider
...
if __name__ == '__main__':
	...
	try:
		loadConfig(ConfigFile, databaseFileOverrider=globals().get('databaseFile'))
	except FileNotFoundError:
		loadConfig(ConfigFile='config_example.json')
	mainClass(classroom)
